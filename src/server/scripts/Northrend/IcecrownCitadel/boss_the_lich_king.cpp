...
class npc_tirion_icc : public CreatureScript
{
    public:
        ...
        struct npc_tirion_iccAI : public ScriptedAI
        {
            ...
            Player* FindNearestPlayer(WorldObject* obj, float range, bool alive = true)
            {
                Player* player = NULL;
                if (obj)
                {
                    Trinity::AnyPlayerInObjectRangeCheck check(obj, range, alive);
                    Trinity::PlayerSearcher<Trinity::AnyPlayerInObjectRangeCheck> searcher(obj, player, check);
                    ...
                    switch(uiStage)
                    {
                        ...
                        case 11:
                        {
                            if(Creature* lich = Unit::GetCreature(*me, uiLichKingGUID))
                            {
                                ...
                                if(Unit* target = FindNearestPlayer(lich, 100.0f))
...
class spell_vile_spirit_distance_check : public SpellScriptLoader
{
    public:
        ...
        class spell_vile_spirit_distance_check_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHit += SpellEffectFn(spell_vile_spirit_distance_check_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_ice_burst_distance_check : public SpellScriptLoader
{
    public:
        ...
        class spell_ice_burst_distance_check_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHit += SpellEffectFn(spell_ice_burst_distance_check_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_lich_king_play_movie : public SpellScriptLoader
{
    public:
        ...
        class spell_lich_king_play_movie_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHit += SpellEffectFn(spell_lich_king_play_movie_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_valkyr_carry_can_cast : public SpellScriptLoader
{
    public:
        ...
        class spell_valkyr_carry_can_cast_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHit += SpellEffectFn(spell_valkyr_carry_can_cast_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
    ...
    public:
        ...
        class spell_valkyr_target_search_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                ...
                OnEffectHit += SpellEffectFn(spell_valkyr_target_search_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_valkyr_eject_passenger : public SpellScriptLoader
{
    public:
        ...
        class spell_valkyr_eject_passenger_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHit += SpellEffectFn(spell_valkyr_eject_passenger_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
...
class spell_vile_spirit_target_search : public SpellScriptLoader
{
    public:
        ...
        class spell_vile_spirit_target_search_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHit += SpellEffectFn(spell_vile_spirit_target_search_SpellScript::HandleScript, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
class spell_lich_king_tirion_mass_resurrection : public SpellScriptLoader
{
    public:
        ...
        class spell_lich_king_tirion_mass_resurrection_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHit += SpellEffectFn(spell_lich_king_tirion_mass_resurrection_SpellScript::MassResurrect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
            }
        };
...
public:
    ...
    CreatureAI* GetAI(Creature* creature) const
    {
        return new npc_shadow_trapAI(creature);
    }
};
